...
class OriginalCa(intelligence.sw):
    """
    Original Cat Algorithm (Cat Swarm Optimization)
    """

    def __init__(self, n, function, lb, ub, dimension, iteration, mr=25, smp=2,
        ...
        super(OriginalCa, self).__init__()
